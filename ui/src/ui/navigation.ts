...
import { RU_TAB_SUBTITLES, RU_TAB_TITLES, RU_UI } from "./i18n.ru.ts";
...
export const TAB_GROUPS = [
  { label: RU_UI.groupAssistant, tabs: ["chat"] },
  {
    label: RU_UI.groupControl,
    tabs: ["channels", "usage", "cron"],
  },
  { label: RU_UI.groupCapabilities, tabs: ["agents", "skills", "mcp", "secrets"] },
  {
...
export function titleForTab(tab: Tab) {
  return RU_TAB_TITLES[tab] ?? RU_UI.groupControl;
}

export function subtitleForTab(tab: Tab) {
  return RU_TAB_SUBTITLES[tab] ?? "";
}
