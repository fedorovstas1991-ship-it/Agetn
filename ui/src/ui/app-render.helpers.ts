      ...
      <button
        ...
        title=${
          disableThinkingToggle
            ? RU_UI.thinkingDisabledOnboarding
            : RU_UI.thinkingToggle
        }
      >
        ${icons.brain}
      </button>
...
export function renderThemeToggle(state: AppViewState) {
  ...
  return html`
    <div class="theme-toggle" style="--theme-index: ${index};">
      <div class="theme-toggle__track" role="group" aria-label=${RU_UI.theme}>
        <span class="theme-toggle__indicator"></span>
        <button
          class="theme-toggle__button ${state.theme === "system" ? "active" : ""}"
          @click=${applyTheme("system")}
          aria-pressed=${state.theme === "system"}
          aria-label=${RU_UI.themeSystem}
          title=${RU_UI.themeSystem}
        >
          ${renderMonitorIcon()}
        </button>
        <button
          ...
          aria-label=${RU_UI.themeLight}
          title=${RU_UI.themeLight}
        >
          ${renderSunIcon()}
        </button>
        <button
          ...
          aria-label=${RU_UI.themeDark}
          title=${RU_UI.themeDark}
        >
          ${renderMoonIcon()}
        </button>
      </div>
